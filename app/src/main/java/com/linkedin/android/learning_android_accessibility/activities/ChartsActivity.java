...
public class ChartsActivity extends BaseActivity implements ChartAccessibilityHelper.DataFormatter {
    ...
    List<Entry> mLineEntries;
    List<BarEntry> mBarLineEntries;

    ChartAccessibilityHelper mLineHelper;
    ChartAccessibilityHelper mBarHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBarHelper = new ChartAccessibilityHelper(barChart, mBarLineEntries);
        ...
        lineChart.setOnHoverListener(new View.OnHoverListener() {
            ...
            public boolean onHover(View view, MotionEvent motionEvent) {
                return mLineHelper.dispatchHoverEvent(motionEvent);
            }
        });
        barChart.setOnHoverListener(new View.OnHoverListener() {
            @Override
            public boolean onHover(View view, MotionEvent motionEvent) {
                return mBarHelper.dispatchHoverEvent(motionEvent);
            }
        });
    }
    ...
    private void setDataForChart(@NonNull BarLineChartBase chart,
        ...
        // Bar data
            ...
            mBarLineEntries = new ArrayList<>();
            for (int i = 0; i < data.length; i++) {
                mBarLineEntries.add(new BarEntry(i, data[i]));
            }

            BarDataSet barDataSet = new BarDataSet(mBarLineEntries, "DataSet");
    ...
    public String getDataDescription(BarLineChartBase chart, List<? extends Entry> entries, Entry entry) {
        ...
        return getResources().getQuantityString(
                R.plurals.charts_plurals_data_description, yValue, xValue, yValue);
    }
}
